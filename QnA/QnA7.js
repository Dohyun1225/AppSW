    ...
    return(
        ...
        <View style={styles.container}>
            ...
            <View style={styles.card}>               
                ...
                <Text style={styles.correct}> correct : 21d + (250)(0.10) less than or equal to 115 </Text>
            </View>
            <View style={styles.card}>               
                <View style={styles.content}>
                ...
                <Text style={styles.answer}> answer :  </Text>
                <Text style={styles.correct}> correct : d less than or equal to 4 2/7 </Text>
            </View>
            <View style={styles.card}>               
                <View style={styles.content}>
                ...
                <Text style={styles.answer}> answer :  </Text>
                <Text style={styles.correct}> correct : 4 days </Text>
            </View>
            <View style={styles.card}>               
                <View style={styles.content}>
                ...
                <Text style={styles.answer}> answer :  </Text>
                <Text style={styles.correct}> correct : 25 </Text>
            </View>
            <View style={styles.card}>               
                <View style={styles.content}>
            ...
            <View style={styles.card}>               
                ...
                <Text style={styles.answer}> answer :  </Text>
                <Text style={styles.correct}> correct : Equivalent to 21[x] + 25 </Text>
            </View>
            <View style={styles.card}>               
                <View style={styles.content}>
            ...
            <View style={styles.card1}>               
                ...
                <Text style={styles.answer}> answer :  </Text>
                <Text style={styles.correct}> correct : 4 </Text>
            </View>
            </ScrollView>
        </View>
    )
