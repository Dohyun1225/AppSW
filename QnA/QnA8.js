    ...
    return(
        ...
        <View style={styles.container}>
            ...
            <View style={styles.card}>               
                ...
                <Text style={styles.correct}> correct : 50 feet </Text>
            </View>
            <View style={styles.card}>               
                <View style={styles.content}>
            ...
            <View style={styles.card}>               
                ...
                <Text style={styles.answer}> answer :  </Text>
                <Text style={styles.correct}> correct : equivalent to 2[x] </Text>
            </View>
            <View style={styles.card}>               
                <View style={styles.content}>
                ...
                <Text style={styles.answer}> answer :  </Text>
                <Text style={styles.correct}> correct : Equivalent to 2[x]+50 </Text>
            </View>
            <View style={styles.card}>               
                <View style={styles.content}>
                ...
                <Text style={styles.answer}> answer :  </Text>
                <Text style={styles.correct}> correct : 2w + 50 is less than or equal to 80 </Text>
            </View>
            <View style={styles.card}>               
                <View style={styles.content}>
                ...
                <Text style={styles.answer}> answer :  </Text>
                <Text style={styles.correct}> correct : w is less than or equal to 15 </Text>
            </View>
            <View style={styles.card}>               
                <View style={styles.content}>
                ...
                <Text style={styles.answer}> answer :  </Text>
                <Text style={styles.correct}> correct : 15 feet </Text>
            </View>
            <View style={styles.card}>               
                <View style={styles.content}>
            ...
            <View style={styles.card}>               
                ...
                <Text style={styles.answer}> answer :  </Text>
                <Text style={styles.correct}> correct : 30 feet </Text>
            </View>
