...
export default function Q6selectScreen(props) {
    return (
        ...
        <TouchableOpacity
        style={styles.button} 
        onPress={()=> {props.navigation.navigate("Qlist61")}}>
            <Text style={styles.text}>Write an equation to solve it</Text>
        </TouchableOpacity>
        <TouchableOpacity
        style={styles.button} 
        onPress={()=> {props.navigation.navigate("Qlist62")}}>
            <Text style={styles.text}>Guess and check</Text>
        </TouchableOpacity>
        <TouchableOpacity
        style={styles.bottom} 
        onPress={()=> {props.navigation.navigate("Qlist63")}}>
            <Text style={styles.text}>Use a diagram to understand the problem</Text>
        </TouchableOpacity>
