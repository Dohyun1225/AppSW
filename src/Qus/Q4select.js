...
export default function Q4selectScreen(props) {
    return (
        ...
        <TouchableOpacity
        style={styles.button} 
        onPress={()=> {props.navigation.navigate("Qlist41")}}>
            <Text style={styles.text}>Guess the number of points and see if it works.</Text>
        </TouchableOpacity>
        <TouchableOpacity
        style={styles.button} 
        onPress={()=> {props.navigation.navigate("Qlist42")}}>
            <Text style={styles.text}>Write equations to solve the problem</Text>
        </TouchableOpacity>
        <TouchableOpacity
        style={styles.bottom} 
        onPress={()=> {props.navigation.navigate("Qlist43")}}>
